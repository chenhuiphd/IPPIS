...
def infer_default():
    ...
    with torch.no_grad():
        for batch_idx, sample in enumerate(tqdm(data_loader, ascii=True)):
            ...
            R_pred = model(I_alpha, I, delta_I,sem)
            # use this to output T_hat for visualization
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--resume', default='checkpoint/checkpoint-epoch290.pth', type=str, help='path to latest checkpoint')
    parser.add_argument('-d', '--device', default=None, type=str, help='indices of GPUs to enable (default: all)')
    parser.add_argument('--data_dir',default='some_test_data/synth/input/',  type=str, help='dir of input data')
    parser.add_argument('--result_dir',default='some_test_data/synth/output/',  type=str, help='dir to save result')
