...
class DatasetMaker:
    def __init__(self, image_dir, depth_dir, segmentation_dir, output_dir, number_of_samples, size=True, mode='train',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_dir', default='./cityscapes_ours', type=str, help='base dir for original data')
    parser.add_argument('--subdir', default='./half_res', type=str, choices=['half_res', 'quarter_res'], help='subdir name')
    parser.add_argument('--mode', default='train', type=str, choices=['train', 'val'], help='mode')
    parser.add_argument('--number_of_samples', default=2975, type=int, help='number of samples to make')#2975
    parser.add_argument('--size', nargs='*', type=int, help='image size, None for keeping unchanged')#default=[256,256],
    parser.add_argument('--prefix', default='./train', type=str, help='prefix of the output file name')#'./val'
    parser.add_argument('--output_dir', default='./data', type=str, help='output dir')
    parser.add_argument('--crop_mode', default='random', type=str, choices=['top_left', 'top_right', 'random'],
                        help='crop mode')
