...
class DefaultModel(BaseModel):
    ...
    def __init__(self, init_dim=64, norm_type='instance', use_dropout=False, C=64, residual=False):
        ...
        self.backbone1 = UnetBackbone(init_dim, output_nc=init_dim, n_downsampling=2, use_conv_to_downsample=True,
                                      norm_type=norm_type, use_dropout=use_dropout, mode='default')

        self.out_block1_1 = nn.Sequential(
            nn.Conv2d(init_dim, C, kernel_size=3, padding=1,stride=1),
            nn.Sigmoid() )
    ...
    def forward(self, I_alpha, I, delta_I):
        ...
        backbone_out1 = self.backbone1(I_alpha)
